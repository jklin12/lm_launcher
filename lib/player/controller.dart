import 'package:lm_launcher/channel/istream.dart'; 
import 'package:flutter_common/flutter_common.dart';
import 'package:lm_launcher/channel/live_stream.dart';
import 'package:lm_launcher/service_locator.dart';
...
class BasePlayerController<T extends IStream> extends PlayerController {
  ...
  BasePlayerController(this.stream, [this.onPlay]) : super( stream.urls[0]);
